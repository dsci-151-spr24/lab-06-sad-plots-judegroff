...
```{r fig.width = 10, fig.fullwidth = TRUE, eval=FALSE}
staff_long %>%
...
I could not figure out how to implement this, but I wanted to attempt to make a plot with "geom_point", having color and/or shape represent the country and x = aquaculture, and y = capture, showing where the countries stack up against each other on a more detailed point plot. I thought the code would look something like this, but was unable to successfully create one that seems to work the way I would like.

```{r}

ggplot(fisheries, aes(x = aquaculture, y = capture, colour = country)) +
  geom_point() +
